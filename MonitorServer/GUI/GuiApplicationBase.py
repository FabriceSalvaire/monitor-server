...
import MonitorServer.Config.Messages as Messages
import MonitorServer.Version as Version
...
class GuiApplicationBase(ApplicationBase, QtGui.QApplication):
    ...
    def post_init(self):
        ...
        self.show_message('Welcome to MonitorServer')
    ...
    def critical_error(self, title='MonitorServer Critical Error', message=''):
    ...
    def about(self):
        ...
        QtGui.QMessageBox.about(self.main_window, 'About MonitorServer', message)
